...
# Choose one specific repository and for that repository, 
# list all the image tags inside, sorted by date. Where the most recent image tag is on top
...
repo_name = "jason-node-application"
